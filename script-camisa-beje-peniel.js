...
btn.addEventListener("click", function(e){
    ...
    if (tamanho1.checked === true){
        link.setAttribute("href", "https://wa.me/5511947461301/?text=Quero%20comprar%20uma%20Camisa%20Leão%20Peniel%20*Bege*%20tamanho:%20PP")
        console.log(link.href)
    } if (tamanho2.checked === true){
        link.setAttribute("href", "https://wa.me/5511947461301/?text=Quero%20comprar%20uma%20Camisa%20Leão%20Peniel%20*Bege*%20tamanho:%20P")
        console.log(link.href)
    } if (tamanho3.checked === true){
        link.setAttribute("href", "https://wa.me/5511947461301/?text=Quero%20comprar%20uma%20Camisa%20Leão%20Peniel%20*Bege*%20tamanho:%20M")
        console.log(link.href)
    } if (tamanho4.checked === true){
        link.setAttribute("href", "https://wa.me/5511947461301/?text=Quero%20comprar%20uma%20Camisa%20Leão%20Peniel%20*Bege*%20tamanho:%20G")
        console.log(link.href)
    } if (tamanho5.checked === true){
        link.setAttribute("href", "https://wa.me/5511947461301/?text=Quero%20comprar%20uma%20Camisa%20Leão%20Peniel%20*Bege*%20tamanho:%20GG")
        console.log(link.href)
    }
